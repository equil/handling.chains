...
@implementation ARHCCHandlingChain
{
}
...
- (NSArray *)prepareElementsByNames:(NSArray *)array
{
    ...
    for (NSString *className in array)
    {
        ...
        ARHCAbstractChainElement *element = [self instantiateElement:elementClass];
        if (element != nil)
        {
...
- (NSArray *)prepareElementsByClasses:(NSArray *)array
{
    ...
    {
        ARHCAbstractChainElement *element = [self instantiateElement:class];
        if (element != nil)
        {
            [result addObject:element];
        }
...
- (ARHCAbstractChainElement *)instantiateElement:(Class)elementClass
{
    ARHCAbstractChainElement *result = nil;
    if (elementClass != nil && [elementClass isSubclassOfClass:[ARHCAbstractChainElement class]])
    {
