...
@implementation ARHCAbstractHandlingChain
{
@private
    NSArray *_elements;
...
- (void)composeQueue:(dispatch_queue_t)queue
{
    ...
    {
        if ([element isKindOfClass:[ARHCAbstractChainElement class]])
        {
            ARHCAbstractChainElement *chainElement = (ARHCAbstractChainElement *) element;
