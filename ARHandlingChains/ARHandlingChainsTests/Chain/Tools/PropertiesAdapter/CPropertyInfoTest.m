...
@interface ARHCPropertyInfo ()

+ (NSMutableDictionary *)extractAttributes:(objc_property_t)property;
@end

@interface CPropertyInfoTest : XCTestCase

@end

@implementation CPropertyInfoTest
{
    Protocol *_protocol;
    ARHCPropertyInfo *_readonlySelector;
    ARHCPropertyInfo *_assignSelector;
    ARHCPropertyInfo *_readonlyClass;
    ARHCPropertyInfo *_assignClass;
    ARHCPropertyInfo *_readonlyStructure;
    ARHCPropertyInfo *_assignStructure;
    ARHCPropertyInfo *_readonlyLong;
    ARHCPropertyInfo *_assignUnsignedLong;
    ARHCPropertyInfo *_readonlyObject;
    ARHCPropertyInfo *_assignObject;
    ARHCPropertyInfo *_weakObject;
    ARHCPropertyInfo *_copyObject;
    ARHCPropertyInfo *_retainObject;
    ARHCPropertyInfo *_strongObject;
}
...
- (void)setUp
{
    ...
    _strongObject = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "strongObject", YES, YES)];
    _retainObject = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "retainObject", YES, YES)];
    _copyObject = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "copyObject", YES, YES)];
    _weakObject = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "weakObject", YES, YES)];
    _assignObject = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "assignObject", YES, YES)];
    _readonlyObject = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "readonlyObject", YES, YES)];
    _assignUnsignedLong = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "assignUnsignedLong", YES, YES)];
    _readonlyLong = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "readonlyLong", YES, YES)];
    _assignStructure = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "assignStructure", YES, YES)];
    _readonlyStructure = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "readonlyStructure", YES, YES)];
    _assignClass = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "assignClass", YES, YES)];
    _readonlyClass = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "readonlyClass", YES, YES)];
    _assignSelector = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "assignSelector", YES, YES)];
    _readonlySelector = [[ARHCPropertyInfo alloc] initWithProperty:protocol_getProperty (_protocol, "readonlySelector", YES, YES)];
}
...
- (void)testExtractNil
{
    NSMutableDictionary *attributes = [ARHCPropertyInfo extractAttributes:nil];
    XCTAssertNotNil(attributes, "[ARHCPropertyInfo extractAttributes:nil] не должен возвращать значение nil");
    XCTAssertEqual(attributes.count, 0, "Словарь, возвращаемый [ARHCPropertyInfo extractAttributes:nil] должен быть пуст");
}

- (void)testInitInfoWithNilProperty
{
    ARHCPropertyInfo *info = [[ARHCPropertyInfo alloc] initWithProperty:nil];
